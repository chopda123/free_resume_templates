...
//         {/* Image Section */}
//         <div
//           className="relative h-[250px] sm:h-[300px] md:h-[400px] bg-gray-100 cursor-pointer overflow-hidden"
...
//           {/* Title — 2-line clamp to avoid card growth */}
//           <h3
//             className="text-base sm:text-lg font-bold text-premium-navy leading-snug"
//             style={{
//               display: '-webkit-box',
//               WebkitLineClamp: 2,
...
//               minHeight: '2.6em' // reserve height for two lines so cards align
//             }}
...
//               {template?.role && (
//                 <span className="text-xs sm:text-sm text-premium-gold bg-premium-gold/10 px-2 py-1 rounded-full">
//                   {template.role.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())}
//                 </span>
//               )}
//             </div>
...
//               whileTap={{ scale: 0.95 }}
//               className="flex-1 text-[10px] sm:text-sm border border-premium-teal text-premium-teal rounded-full py-1.5 sm:py-2 hover:bg-premium-teal/5 active:scale-95 transition"
//             >
//               Preview
//             </motion.button>
//             <motion.a
...
//               whileHover={{ scale: 1.04 }}
//               whileTap={{ scale: 0.95 }}
//               className="flex-1 text-[10px] sm:text-sm bg-premium-gold text-premium-navy rounded-full py-1.5 sm:py-2 text-center hover:bg-premium-gold/90 active:scale-95 transition"
//             >
//               Edit in Canva
//             </motion.a>
//           </div>

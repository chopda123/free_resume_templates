...
//             gtag('js', new Date());
//             gtag('config', 'G-6KX3J4SWZ7', {debug_mode: true});
//           `}
//         </Script>
//       </head>
...
export const metadata = {
  // This sets the base URL for your entire website
  metadataBase: new URL("https://www.freeresume.shop"),

  title: "FreeResume | Premium Resume Templates",
  description:
    "Professionally designed resume templates to elevate your career prospects. Edit directly in Canva.",

  // This tells search engines your canonical (preferred) URL is the www version
  alternates: {
    canonical: "/",
  },
};
...
export default function RootLayout({ children }) {
  return (
    <html
      ...
      className={`scroll-smooth ${inter.variable} ${playfair.variable}`}
    >
      {/* The <head> tag is removed from here. 
        Next.js automatically creates it using the metadata object above.
      */}
      <body className="bg-premium-cream text-premium-navy font-sans antialiased">
        {/* Navigation - Removed sticky positioning */}
        ...
        {/* ✅ Google Analytics (GA4) Scripts moved to the end of the body */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-6KX3J4SWZ7"
          strategy="afterInteractive"
        />

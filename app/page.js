          ...
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="relative" ref={testimonialRef}>
              <div className="flex overflow-x-auto space-x-4 md:space-x-6 pb-6 md:pb-8 scrollbar-hide" style={{ scrollbarWidth: 'none' }}>
                {[
                  { name: "Rajesh Kumar", role: "Software Engineer", rating: 5 },
                  { name: "Priya Sharma", role: "Marketing Manager", rating: 5 },
                  { name: "Amit Patel", role: "Product Designer", rating: 5 },
                  { name: "Sneha Gupta", role: "Data Analyst", rating: 5 }
                  ...
                  >
                    ...
                    <p className="text-gray-300 text-sm md:text-base">
                      &quot;This template helped me stand out from hundreds of applicants. 
                      I received interview calls within a week of updating my resume!&quot;
                    </p>
                  </motion.div>
                ))}
              </div>

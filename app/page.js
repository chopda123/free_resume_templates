          ...
          >
            ...
            <div className="flex flex-col space-y-8 items-center mt-12">
              <Link 
                href="/templates"
                onClick={() => {
                  // GA Event: Track mobile menu "Templates" click
              ...
              <Link 
                href="/blog"
                onClick={() => {
                  // GA Event: Track mobile menu "Blog" click
                  if (typeof window.gtag === 'function') {
                    window.gtag('event', 'navigation_click', {
                      'link_text': 'Blog',
                      'location': 'Mobile Menu'
              ...
              <Link 
                href="/templates"
                onClick={() => {
                  // GA Event: Track mobile menu "Get Started" click
                  if (typeof window.gtag === 'function') {
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-8 items-center">
              <Link 
                href="/templates"
                onClick={() => {
                  // GA Event: Track desktop header "Templates" click
                  if (typeof window.gtag === 'function') {
                    window.gtag('event', 'navigation_click', {
                      'link_text': 'Templates',
              ...
              <Link 
                href="/blog"
                onClick={() => {
                  // GA Event: Track desktop header "Blog" click
                  if (typeof window.gtag === 'function') {
                    window.gtag('event', 'navigation_click', {
                      'link_text': 'Blog',
                      'location': 'Desktop Header'
              ...
              <Link 
                href="/templates"
                onClick={() => {
                  // GA Event: Track desktop header "Get Started" click
                  if (typeof window.gtag === 'function') {
                    window.gtag('event', 'cta_click', {
                      'cta_name': 'Get Started',
                      'location': 'Desktop Header'
              ...
              >
                ...
                <div className="flex flex-row gap-2 sm:gap-3 md:gap-4 w-full sm:w-auto justify-center sm:justify-start">
                  <Link 
                    href="/templates"
                    onClick={() => {
                      // GA Event: Track "Browse Templates" click in hero section
                      if (typeof window.gtag === 'function') {
                        window.gtag('event', 'cta_click', {
                          'cta_name': 'Browse Templates',
          ...
          <div className="container mx-auto max-w-7xl">
            ...
            >
              <Link 
                href="/templates"
                onClick={() => {
                  // GA Event: Track "View All Templates" click
                  if (typeof window.gtag === 'function') {
                    window.gtag('event', 'cta_click', {
                      'cta_name': 'View All Templates',
                      'location': 'Home Page Featured Section'
                    });
                  }
                }}
